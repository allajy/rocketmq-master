package com.bxc.order.service.impl;
...
import com.bxc.order.service.producer.OrderlyProducer;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Reference(version = "1.0.0",
            ...
            interfaceName = "com.bxc.store.service.StoreServiceApi",
            check = false,
            timeout = 3000,
            retries = 0
    )
    ...
    @Autowired
    private OrderlyProducer orderlyProvider;
    ...
    public void sendOrderlyMessage4Pkg(String userId, String orderId) {
        ...
        orderlyProvider.sendOrderlyMessages(messageList, messageQueueNumber);
    }
}
